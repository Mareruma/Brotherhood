...
```mermaid
graph TD
    A[91 Farmland Tiles<br>230M Tons/Year] -->|108,000 Humans Per Hex| B(Centralized Silo Ramps)
    B -->|Loaded into 10,000-Ton Capacity| C[The Abyss Cruisers]
    C -->|Pulled 150-200km in 1 Day by| D[Storm Giants]
    D -->|Via Giant Highways| E[Rhaxdanpoint Port]
    E -->|30% Domestic Consumption| F[Inland Megalopolises]
    E -->|70% Overseas Export| G[Overseas Empires & Distant Lands]
```
