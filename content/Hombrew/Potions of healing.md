...
A character proficient with an Herbalism Kit can gather medicinal plants and rare botanical ingredients while traveling and use them to brew healing potions.

### Foraging

Once per long rest, while traveling or during a short or long rest, you can spend 1 hour foraging for useful herbs. At the end of that time, make a Wisdom (Nature) check. The result determines what ingredients you discover.

##### Foraging

| Nature Check | Ingredients Found                       |
| :----------: | :-------------------------------------- |
|  14 or lower | No useful ingredients                   |
|     15–19    | 1d8 Herbal Units                        |
|     20–24    | 2d8 Herbal Units and 1 Rare Ingredient  |
| 25 or higher | 3d8 Herbal Units and 2 Rare Ingredients |

### Regional Ingredients

The ingredients found depend on the surrounding terrain.

| Terrain            | Herbal Unit         | Rare Ingredient   |
| :----------------- | :------------------ | :---------------- |
| Forest or Swamp    | Sanguine Briar      | Gloomspore Bulb   |
| Mountain or Desert | Frost-Shard Thistle | Cinder-Bloom Lily |
| Grassland or Coast | Aether-Leaf Fern    | Sirensong Kelp    |
